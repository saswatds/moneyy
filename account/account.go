// Service account implements account management functionality.
package account
...
//
//encore:api public path=/accounts method=POST
func Create(ctx context.Context, req *CreateAccountRequest) (*Account, error) {
...
//
//encore:api public path=/summary/accounts method=GET
func Summary(ctx context.Context) (*AccountSummary, error) {
	// TODO: Get user ID from auth context
	userID := "temp-user-id" // Placeholder until auth is implemented
...
//
//encore:api public path=/accounts method=GET
func List(ctx context.Context) (*ListAccountsResponse, error) {
	// TODO: Get user ID from auth context
	userID := "temp-user-id" // Placeholder until auth is implemented
...
//
//encore:api public path=/accounts/:id method=GET
...
//
//encore:api public path=/accounts/:id method=PUT
func Update(ctx context.Context, id string, req *UpdateAccountRequest) (*Account, error) {
	// TODO: Get user ID from auth context and verify ownership
	userID := "temp-user-id" // Placeholder until auth is implemented

	// First, get the current account
	account, err := Get(ctx, id)
	if err != nil {
		return nil, err
	}
...
//
//encore:api public path=/accounts/:id method=DELETE
func Delete(ctx context.Context, id string) (*DeleteAccountResponse, error) {
	// TODO: Get user ID from auth context and verify ownership
	userID := "temp-user-id" // Placeholder until auth is implemented
