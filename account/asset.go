...
//
//encore:api public method=POST path=/accounts/:accountID/asset
func CreateAssetDetails(ctx context.Context, accountID string, req *CreateAssetDetailsRequest) (*AssetDetails, error) {
...
//
//encore:api public method=GET path=/accounts/:accountID/asset
func GetAssetDetails(ctx context.Context, accountID string) (*AssetDetails, error) {
	var details AssetDetails
...
//
//encore:api public method=PUT path=/accounts/:accountID/asset
func UpdateAssetDetails(ctx context.Context, accountID string, req *UpdateAssetDetailsRequest) (*AssetDetails, error) {
	// Validate depreciation method requirements
	if err := validateAssetDetails(req.DepreciationMethod, req.UsefulLifeYears, req.DepreciationRate); err != nil {
		return nil, err
	}
...
//
//encore:api public method=GET path=/accounts/:accountID/asset/valuation
func GetAssetValuation(ctx context.Context, accountID string) (*AssetWithCurrentValue, error) {
	details, err := GetAssetDetails(ctx, accountID)
	if err != nil {
		return nil, err
	}

	asOfDate := time.Now()
	currentValue, accumulatedDepreciation, err := calculateCurrentValue(ctx, details, asOfDate)
	if err != nil {
...
//
//encore:api public method=GET path=/assets/summary
func GetAssetsSummary(ctx context.Context) (*AssetsSummaryResponse, error) {
...
//
//encore:api public method=POST path=/accounts/:accountID/asset/depreciation
func RecordDepreciation(ctx context.Context, accountID string, req *CreateDepreciationEntryRequest) (*DepreciationEntry, error) {
...
//
//encore:api public method=GET path=/accounts/:accountID/asset/depreciation
func GetDepreciationHistory(ctx context.Context, accountID string) (*DepreciationEntriesResponse, error) {
	rows, err := db.Query(ctx, `
...
//
//encore:api public method=GET path=/accounts/:accountID/asset/depreciation-schedule
func GetDepreciationSchedule(ctx context.Context, accountID string) (*DepreciationScheduleResponse, error) {
	details, err := GetAssetDetails(ctx, accountID)
	if err != nil {
		return nil, err
	}
...
//
//encore:api public method=POST path=/accounts/:accountID/asset/sync-balance
func SyncAssetBalance(ctx context.Context, accountID string) error {
	details, err := GetAssetDetails(ctx, accountID)
	if err != nil {
	...
	asOfDate := time.Now()
	currentValue, _, err := calculateCurrentValue(ctx, details, asOfDate)
	if err != nil {
...
func calculateCurrentValue(ctx context.Context, asset *AssetDetails, asOfDate time.Time) (currentValue, accumulatedDepreciation float64, err error) {
	...
	case "manual":
		return getLatestManualValue(ctx, asset.AccountID, asOfDate)
	default:
...
func getLatestManualValue(ctx context.Context, accountID string, asOfDate time.Time) (float64, float64, error) {
