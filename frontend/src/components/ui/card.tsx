...
function Card({
  ...
  return (
    <div
      data-slot="card"
      data-size={size}
      className={cn("glass-card bg-card text-card-foreground gap-3 overflow-hidden rounded-lg py-3 text-xs/relaxed shadow-sm has-[>img:first-child]:pt-0 data-[size=sm]:gap-2 data-[size=sm]:py-2 *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg group/card flex flex-col", className)}
      {...props}
    />
  )
}
